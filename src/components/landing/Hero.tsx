      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12 pt-8 border-t border-primary-200">
              {stats.map((stat) => (
          ...
          <div className="relative">
            <div className="relative bg-white rounded-2xl shadow-2xl border border-gray-200 p-6 md:p-8">
              <div className="flex items-center gap-2 mb-6 pb-4 border-b border-gray-100">
                ...
                <span className="ml-4 text-sm text-gray-500">api-demo.js</span>
              </div>
